			...
			<div class="has-sidebar sm-padded" >
				<div id="post-body-content" class="">			
					<div class="meta-box-sortabless">			
						...
						?>
						<p><?php _e('Please refer to the WordPress Codex page for <a target="_blank" href="http://codex.wordpress.org/Function_Reference/register_taxonomy">register_taxonomy</a> for full descriptions of the labels and how they are used.'); ?></p>
						<?php mediatag_settings_boxfooter(false); ?>
